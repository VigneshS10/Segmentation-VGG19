...
class FER2013Trainer(Trainer):
    ...
    def __init__(self, model, train_set, val_set, test_set, configs):
        ...
        # self._optimizer = SGD(params=self._model.parameters(), lr=self._lr, momentum=self._momentum, nesterov=True, weight_decay=self._weight_decay)
        ...
        # self._checkpoint_path = os.path.join(
        #     self._checkpoint_dir,
        #   'vgg_19_bn/vgg19_bn_trail-3_2021Aug14_13.53'
        # )
    ...
    def _calc_acc_on_private_test_with_tta(self):
        ...
        with torch.no_grad():
            for idx in tqdm(
                ...
                np.save('/content/drive/MyDrive/Segmentation VGG - Results/pred_list.npy', pred_list)
                np.save('/content/drive/MyDrive/Segmentation VGG - Results/target_list.npy', target_list)
    ...
    def train(self):
        ...
        # training stop
        try:
            state = torch.load('/content/drive/MyDrive/Segmentation VGG - Results/Trained model/Segmentation_VGG_final_model')
