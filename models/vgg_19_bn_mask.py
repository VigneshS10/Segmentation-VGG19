...
class VGG_mask(nn.Module):
    def __init__(self, in_channels=3, num_classes=1000,init_weights=True):
        ...
        state_dict = torch.load('/content/drive/MyDrive/checkpoints/vgg_19_bn/vgg19_bn_trail-2_2021Aug14_22.47')['net']
...
def vgg19_bn_mask(in_channels =3, num_classes = 1000, progress=True, **kwargs):  
